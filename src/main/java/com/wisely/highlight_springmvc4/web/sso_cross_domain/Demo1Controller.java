package com.wisely.highlight_springmvc4.web.sso_cross_domain;

import com.wisely.highlight_springmvc4.web.sso_cross_domain.utils.Demo1Tool;
...
public class Demo1Controller {
        ...
        if(cookies != null){
            for(Cookie cookie:cookies){
                ...
                if(cookie.getName().equals("ssocookie")){
                    ...
                    if(result.equals("1")){
                        return "sso_cross_domain/success1";
                    }
                }
            }
        }
        //返回登录界面
        request.setAttribute("path","demo1");
        request.setAttribute("gotoUrl","http://www.a.com:8082/demo1/main");
    ...
    public String login(String username,String password,HttpServletRequest request){
        ...
        //统一登录接口：检查username和password是否有效
